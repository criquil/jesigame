...
var audio = new Audio('LuckyWheel.mp3');
...
prizes[0] = {"name" : "Suerte", "startAngle" : 0,   "endAngle" : 44};  // Note how prize end angle is 1 less than start angle of next prize so no overlap.
prizes[1] = {"name" : "Biología", "startAngle" : 45,  "endAngle" : 89};
prizes[2] = {"name" : "Aritmética", "startAngle" : 90,  "endAngle" : 134};
prizes[3] = {"name" : "Álgebra", "startAngle" : 135, "endAngle" : 179};
prizes[4] = {"name" : "Suerte", "startAngle" : 180, "endAngle" : 224};
prizes[5] = {"name" : "Cs. Naturales", "startAngle" : 225, "endAngle" : 269};
prizes[6] = {"name" : "Geometría", "startAngle" : 270, "endAngle" : 314};
prizes[7] = {"name" : "Físico Quimica", "startAngle" : 315, "endAngle" : 360};
...
$( document ).ready(function() {
					...
					$("#player1frame").addClass("disabledbutton");
					$("#player2frame").addClass("disabledbutton");
